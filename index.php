...
Kirby::plugin('s00500/kirby3-lightbox-gallery', [
    'tags' => [
        'gallery' => [
            ...
            'html' => function ($tag) use ($tagname) {
                ...
                foreach ($images as $image) {
                    ...
                    if ($image_file) {
                        array_push($image_files, $image_file);
                    }
